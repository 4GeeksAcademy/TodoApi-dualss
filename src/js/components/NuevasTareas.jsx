...
const NuevasTareas = () => {
    ...
    return (
            ...
            <form onSubmit={envioFormulario}>
                ...
                <label className="">Nueva tarea:</label>
                <input className="m-3" type="text" placeholder="Tarea nueva" value={tarea} onChange={(t) => setTarea(t.target.value)}/>
